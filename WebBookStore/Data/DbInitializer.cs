    ...
    public class DbInitializer : DropCreateDatabaseIfModelChanges<StoreDbContext>
    {
        protected override void Seed(StoreDbContext context)
        {
            ...
            var books = new List<Book>
            {
                ...
                new Book { Title = "Chú Thuật Hồi Chiến Tập 3", Author = "GEGE AKUTAMI", Publisher = "NXB Trẻ", PublishYear = 2023, Price = 35000, StockQuantity = 100, ImageUrl = "~/Content/images/tap5.png", Description = "Những trận chiến chú thuật đỉnh cao.", Language = "Tiếng Việt", CategoryId = 2, IsActive = true, CreatedDate = DateTime.Now.AddDays(-8) },
                new Book { Title = "Tokyo Ghoul:re Tập 4", Author = "SUI ISHIDA", Publisher = "NXB Trẻ", PublishYear = 2021, Price = 115000, StockQuantity = 35, ImageUrl = "~/Content/images/tap6.png", Description = "Thế giới của Ghoul và con người đầy phức tạp.", Language = "Tiếng Việt", CategoryId = 2, IsActive = true, CreatedDate = DateTime.Now.AddDays(-7) },
                new Book { Title = "Cho Tôi Xin Một Vé Đi Tuổi Thơ", Author = "NGUYỄN NHẬT ÁNH", Publisher = "NXB Trẻ", PublishYear = 2018, Price = 80000, DiscountPrice = 60000, StockQuantity = 150, ImageUrl = "~/Content/images/tap7.png", Description = "Hồi ức tuổi thơ trong veo và đầy cảm xúc.", Language = "Tiếng Việt", CategoryId = 3, IsActive = true, CreatedDate = DateTime.Now.AddDays(-20) },
                ...
                new Book { Title = "Sword Art Online Progressive Tập 7", Author = "REKI KAWAHARA", Publisher = "IPM, Hà Nội", PublishYear = 2023, Price = 130000, StockQuantity = 20, ImageUrl = "~/Content/images/tap4.png", Description = "Những bí ẩn của tầng 7 đang chờ được khám phá.", Language = "Tiếng Việt", CategoryId = 1, IsActive = true, CreatedDate = DateTime.Now.AddDays(-3) },
